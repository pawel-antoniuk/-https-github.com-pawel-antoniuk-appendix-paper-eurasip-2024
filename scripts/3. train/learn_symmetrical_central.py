...
df = pd.read_csv('../extract/features_symmetrical_central.csv')
...
for i in range(final_iterations):
    ...
    # save final result
    save_progress(models[i], label=f'symmetrical_central_ild_{i}')
...
save_progress(models, label=f'symmetrical_central_ild_all')
